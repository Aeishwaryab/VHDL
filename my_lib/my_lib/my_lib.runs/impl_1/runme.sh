...
HD_PWD='C:/Users/ga62mos/VHLDsample/my_lib/my_lib/my_lib.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log GenAnd.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source GenAnd.tcl -notrace
