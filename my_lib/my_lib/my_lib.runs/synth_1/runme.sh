...
HD_PWD='C:/Users/ga62mos/VHLDsample/my_lib/my_lib/my_lib.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log GenAnd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source GenAnd.tcl
